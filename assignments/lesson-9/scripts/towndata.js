...
xmlhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
        ...
        franklin = $('#franklin-json').append("<br>" + " It was founded in " + myObj.towns[0].yearFounded);
        franklin = $('#franklin-json').append(" with population of " + myObj.towns[0].currentPopulation);
        franklin = $('#franklin-json').append(". Annual rainfall is " + myObj.towns[0].averageRainfall + "  inches");
